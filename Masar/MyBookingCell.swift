...
class MyBookingCell: UITableViewCell {
    ...
    let iconView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(red: 255/255, green: 149/255, blue: 0/255, alpha: 0.1)
    ...
    let iconImageView: UIImageView = {
        let iv = UIImageView()
        iv.image = UIImage(systemName: "calendar.badge.clock")
        iv.tintColor = UIColor(red: 255/255, green: 149/255, blue: 0/255, alpha: 1.0)
