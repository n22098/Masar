...
final class ProviderChatListViewController: UIViewController {
    ...
    private var conversations: [MessageConversation] = []  // نستخدم MessageConversation
...
extension ProviderChatListViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        // 🛠 التعديل: إنشاء كائن AppUser وتمريره بدلاً من الخصائص الملغاة
        let clientUser = AppUser(
            id: conversation.otherUserId,
            name: conversation.otherUserName,
            email: conversation.otherUserEmail,
            phone: "", // غير مطلوب في الشات
            role: "seeker" // نفترض أنه عميل
        )
        
        // تمرير البيانات بالطريقة الجديدة
        chatVC.otherUser = clientUser
